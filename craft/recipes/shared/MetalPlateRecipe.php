...
class MetalPlateRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_METAL_PLATE;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_MATERIAL_METAL_PLATE);
    }

    public function getPrice(): Money
    {
        return $this->moneyHelper->parse(10_000, Currency::DUST);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_RESOURCE_IRON, 'volume' => 250]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_RESOURCE_COPPER, 'volume' => 50]
            ]
        ];
    }
