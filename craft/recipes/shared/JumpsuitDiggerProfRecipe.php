...
class JumpsuitDiggerProfRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_JUMPSUIT_DIGGER_PROF;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_JUMPSUIT_DIGGER_PROF);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_GEAR, 'volume' => 125]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_IRON_BRACKET, 'volume' => 100]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
