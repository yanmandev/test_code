...
class RapierRetributionRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_RAPIER_RET;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_RAPIER_RET);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_MATERIAL_BLADE, 'volume' => 50]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_SCRAP_METAL, 'volume' => 125]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_RESOURCE_MICA, 'volume' => 2_500]
            ],
            [
