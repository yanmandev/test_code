...
class BoltRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_BOLT;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_MATERIAL_BOLT);
    }

    public function getPrice(): Money
    {
        return $this->moneyHelper->parse(20_000, Currency::DUST);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_RESOURCE_IRON, 'volume' => 150]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_RESOURCE_COPPER, 'volume' => 75]
            ]
        ];
    }
