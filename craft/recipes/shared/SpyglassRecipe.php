...
class SpyglassRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_SPYGLASS;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_SPYGLASS);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_MATERIAL_CRYSTAL_REFLECTOR, 'volume' => 10]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_SAPPHIRE_GLASS, 'volume' => 75]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_METAL_TUBE, 'volume' => 50]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_SHARD_QUARK, 'volume' => 5]
            ],
            [
