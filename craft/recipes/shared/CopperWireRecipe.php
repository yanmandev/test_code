...
class CopperWireRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_COPPER_WIRE;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_MATERIAL_COPPER_WIRE);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_RESOURCE_IRON, 'volume' => 30]
            ],
        ];
    }
