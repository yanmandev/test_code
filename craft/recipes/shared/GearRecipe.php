...
class GearRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_GEAR;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_MATERIAL_GEAR);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_MATERIAL_SCRAP_METAL, 'volume' => 5]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_IRON_BRACKET, 'volume' => 10]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_METAL_PLATE, 'volume' => 3]
            ]
        ];
    }
