...
class RivetRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_RIVET;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_MATERIAL_RIVET);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_NUT, 'volume' => 2]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_METAL_PLATE, 'volume' => 1]
            ]
        ];
    }
