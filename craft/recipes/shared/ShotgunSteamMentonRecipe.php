...
class ShotgunSteamMentonRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_SHOTGUN_STEAM_MEN;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_SHOTGUN_STEAM_MEN);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_MATERIAL_METAL_PLATE, 'volume' => 10]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_METAL_TUBE, 'volume' => 20]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_ROLL_LEATHER, 'volume' => 75]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_RIVET, 'volume' => 75]
            ],
            [
