...
class SerumPurityRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_SERUM_PURITY;
    }
    ...
    {
        $loot = Loots::obtain(Loots::NAME_POTION_SERUM_PURITY);
        $loot->setVolume(10);
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_RESOURCE_MICA, 'volume' => 1_500]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_POTION_AQUA_DISTILLED_DUST, 'volume' => 15]
            ],
            [
