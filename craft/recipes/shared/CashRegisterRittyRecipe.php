...
class CashRegisterRittyRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_CASH_REGISTER_RITTY;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_CASH_REGISTER_RITTY);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            [
                ...
                'config' => ['name' => Loots::NAME_RESOURCE_IRON, 'volume' => 5_000]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_RESOURCE_COPPER, 'volume' => 4_000]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_GEAR, 'volume' => 50]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_IRON_BRACKET, 'volume' => 50]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_COPPER_WIRE, 'volume' => 50]
            ],
            [
