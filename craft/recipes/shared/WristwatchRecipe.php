...
class WristwatchRecipe extends BaseRecipe implements RecipeInterface
{
    public function getId(): string
    {
        return Recipes::ID_WRISTWATCH;
    }
    ...
    {
        return Loots::obtain(Loots::NAME_EQUIPMENT_WRISTWATCH);
    }
    ...
    public function getSchemeComponents(): array
    {
        return [
            ...
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_SAPPHIRE_GLASS, 'volume' => 100]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
                'config' => ['name' => Loots::NAME_MATERIAL_ROLL_LEATHER, 'volume' => 125]
            ],
            [
                'type' => RecipeComponents::TYPE_LOOT,
